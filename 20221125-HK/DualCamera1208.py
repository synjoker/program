...
class HKCameraInitialization:
    ...
    def Savepyrometric(self, tem1):
        ...
        img16 = np.uint16(tem1)
        cv2.imwrite(
            "20221125-HK/" + timeNow + '/' + timeNow1 + 'pytometrictemperature.tif',
            img16)
        print("the pytrometric temperature image is refreshed")
...
if __name__ == "__main__":
    ...
    while (True):
        ...
        # pyimg1 = np.roll(originalsrc2, (delteX, delteY), (0, 1))
        # pyimg2 = originalsrc1
        # # 相机1&2双光测温
        # Tpic16, Tpic8, maxtemperature = Pyrometricfunc(pyimg1,
        #                                                pyimg2, Lambda2,
        #                                                Lambda1)
        # cv2.imshow("1", Tpic8)
