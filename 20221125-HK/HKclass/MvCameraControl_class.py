...
from HKclass.PixelType_header import *
from HKclass.CameraParams_const import *
from HKclass.CameraParams_header import *
from HKclass.MvErrorDefine_const import *
...
class MvCamera():
    ...
    def MV_CC_OpenParamsGUI(self):
        ...
        # C原型:int MV_CC_OpenParamsGUI  ( IN void *  handle ) 
