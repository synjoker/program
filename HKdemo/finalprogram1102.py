...
if __name__ == "__main__":
    ...
    while keyValue != ord('q'):
        ...
        cv2.putText(Tpic, "maxpoint="+str(temperwhere), (0, 60), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 2)
        cv2.putText(Tpic, "maxtemperature: "+str(int(maxtemperature)), (0, 120), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 2)
        ...
        cv2.imshow("700nm grey pic part", cv2.resize(src1[(src1x-halfwidth):(src1x+halfwidth),(src1y-halfwidth):(src1y+halfwidth)],dsize=None,fx=10, fy=10, interpolation=INTER_NEAREST))
        ...
        cv2.imshow("800nm grey pic part", cv2.resize(src2[(src2x-halfwidth):(src2x+halfwidth),(src2y-halfwidth):(src2y+halfwidth)],dsize=None,fx=10, fy=10, interpolation=INTER_NEAREST))
